...
public class ReleaseManagementCI extends Notifier implements Serializable {
    ...
    public boolean perform(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener) throws InterruptedException, IOException
    {
        ...
        listener.getLogger().println("Collection URL is: " + collectionUrl);
        if (build.getResult() == Result.SUCCESS)
        {
            ReleaseManagementHttpClient releaseManagementHttpClient = 
                    new ReleaseManagementHttpClient(
                            this.collectionUrl.toLowerCase().replaceFirst("dev.azure.com", "vsrm.dev.azure.com"),
                            this.username,
                            this.password);
            listener.getLogger().println("ReleasEManagementHTTPClient toString: " + releaseManagementHttpClient.toString());
            try 
            {
                ...
                {
                	listener.getLogger().println("ReleasEManagementHTTPClient toString: " + rd.toString());
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Publisher>
    {
        ...
        public ListBoxModel doFillReleaseDefinitionNameItems(@QueryParameter String collectionUrl,
            ...
            try {
                ReleaseManagementHttpClient releaseManagementHttpClient =
                        new ReleaseManagementHttpClient(
                                collectionUrl.toLowerCase().replaceFirst("dev.azure.com", "vsrm.dev.azure.com"),
                                username,
                                password);

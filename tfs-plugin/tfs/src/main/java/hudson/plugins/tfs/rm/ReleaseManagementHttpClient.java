...
{
	private static final Logger logger = Logger.getLogger(ReleaseManagementHttpClient.class.getName());
    ...
    public List<ReleaseDefinition> GetReleaseDefinitions(String project) throws ReleaseManagementException
    {
        ...
        logger.log(Level.WARNING, "Url from ReleaseManegentHTTPClient getReleaseDef: " + url);
    ...
    private class DefinitionResponse
    {
        ...
        */
        ...
        public String toString(){//overriding the toString() method  
        	  return "HttpClient accountUrl is: " + accountUrl;  
        	 }  
    }
}
